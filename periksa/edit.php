...
if (isset($_POST['submit'])) {
    ...
    $data = [$_id, $_tanggal, $_berat, $_tinggi, $_tensi, $_keterangan, $_pasien_id, $_paramedik_id, $id];
    // Query SQL untuk update data periksa berdasarkan id
    $sql = "UPDATE periksa SET id = ?, tanggal = ?, berat = ?, tinggi = ?, tensi = ?,keterangan = ?, pasien_id = ?, paramedik_id = ? WHERE id = ?";
    $stmt = $dbh->prepare($sql);
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="edit.php?id=<?= $row['id'] ?>" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-8">
                                        <input id="tensi" name="tensi" type="tensi" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row">
                        ...
                        <div class="card-footer">
                            Projek 1 - Aplikasi Web Puskesmas Milik Siti Salwa Salsabila
                        </div>
                        <!-- /.card-footer-->
                    </div>
                    <!-- /.card -->
