...
#header blockquote{
    background-color: rgb(98, 223, 236);
    border:2px dotted;
}
.menu ul{
    list-style: none;
...
Aku mendengarkan Indonesia <br/>
        ...
        <div class="gambar">
            <img src="dist/img/burung1.jpg" alt="Burung Perkutut Jawa"/>
            <img src="dist/img/burung2.jpg" alt="Burung Suara Emas"/>       
        </div>
        <div class="isi">
            <p class="fp">
        ...
        <div class="koleksi">
            <img src="dist/img/burung1.jpg"/>
            <img src="dist/img/burung2.jpg"/>
            <img src="dist/img/burung3.jpg"/>
            <img src="dist/img/burung4.jpg"/>          
        </div>
        <br>
        <br>
        <div class="promo">
          ...
          <div>
            ...
            <ol>
                <li><a href="https://tokopedia.com">tokopedia</a></li>
                <li><a href="https://www.bukalapak.com/">Bukalapak</a></li>
                <li><a href="https://shopee.com">shopee</a></li>
            </ol>
          </div>
